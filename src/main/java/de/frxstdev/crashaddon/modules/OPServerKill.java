...
public class OPServerKill extends Module {
    ...
    public OPServerKill() {
        super(CrasherUtils.CATEGORY, "OPServerKillModule", "Runs a set of commands to disable a server. Requires OP. (ONLY USE IF YOU'RE 100% SURE)");
    }
